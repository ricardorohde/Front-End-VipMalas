...
switch ($cur_page) {
	...
	case 'como-funciona.php':
		$Header_Title = 'Como funciona';
		//$Header_Description = '';
		break;
	case 'quero-alugar.php':
		$Header_Title = 'Quero Alugar';
		//$Header_Description = '';
		break;
	case 'sobre.php':
		$Header_Title = 'Vip Malas';
		//$Header_Description = '';
		break;
	case 'duvidas.php':
		$Header_Title = 'Dúvidas Frequentes';
		//$Header_Description = '';
		break;
	case 'contato.php':
...
?>
	...
	<? if ($Header_BaseURL) { ?>
		<base href="<?= $Header_BaseURL ?>"><? } ?>
	<? if ($Header_GoogleWebMasterTools) { ?>
		<meta name="google-site-verification" content="<?= $Header_GoogleWebMasterTools ?>" /><? } ?>
	<? if ($Header_Keywords) { ?>
	...
	<? if ($Header_PlaceLati) { ?>
		<meta property="place:location:latitude" content="<?= $Header_PlaceLati ?>" /><? } ?>
	<? if ($Header_PlaceLong) { ?>
		<meta property="place:location:longitude" content="<?= $Header_PlaceLong ?>" /><? } ?>
	<? if ($Header_Endereco) { ?>
		<meta property="business:contact_data:street_address" content="<?= $Header_Endereco ?>" /><? } ?>
	<? if ($Header_Cidade) { ?>
		<meta property="business:contact_data:locality" content="<?= $Header_Cidade ?>" /><? } ?>
	<? if ($Header_CEP) { ?>
		<meta property="business:contact_data:postal_code" content="<?= $Header_CEP ?>" /><? } ?>
	<? if ($Header_Pais) { ?>
		<meta property="business:contact_data:country_name" content="<?= $Header_Pais ?>" /><? } ?>
	<? if ($Header_Email) { ?>
		<meta property="business:contact_data:email" content="<?= $Header_Email ?>" /><? } ?>
	<? if ($Header_Telefone) { ?>
		<meta property="business:contact_data:phone_number" content="<?= $Header_Telefone ?>" /><? } ?>
	<? if ($Header_Site) { ?>
		<meta property="business:contact_data:website" content="<?= $Header_Site ?>" /><? } ?>

	<meta name="twitter:card" content="summary">
	<? if ($Header_Twitter) { ?>
		<meta name="twitter:site" content="@<?= $Header_Twitter ?>"><? } ?>
	<meta name="twitter:title" content="<?= $Header_Title ?>">
	<meta name="twitter:description" content="<?= $Header_Description ?>">
	<? if ($Header_ImgAvatar) { ?>
		<meta name="twitter:image" content="<?= $Header_ImgAvatar ?>"><? } ?>

	<meta property="og:title" content="<?= $Header_Title ?>" />
	<? if ($Header_FaceType) { ?>
		<meta property="og:type" content="<?= $Header_FaceType ?>" /><? } ?>
	<meta property="og:url" content="<?= $Header_UrlPage ?>" />
	<? if ($Header_ImgAvatar) { ?>
		<meta property="og:image" content="<?= $Header_ImgAvatar ?>" /><? } ?>
	<meta property="og:description" content="<?= $Header_Description ?>" />
	<? if ($Header_NomeEmpresa) { ?>
		<meta property="og:site_name" content="<?= $Header_NomeEmpresa ?>" /><? } ?>
	<? if ($Header_FaceID) { ?>
		<meta property="fb:admins" content="<?= $Header_FaceID ?>" /><? } ?>
	...
	<? if ($Header_ImgAvatar) { ?>
		<meta itemprop="image" content="<?= $Header_ImgAvatar ?>"><? } ?>